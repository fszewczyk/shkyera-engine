...
GizmoSystem::GizmoSystem(std::shared_ptr<Registry> registry)
    ...
    {  // Translation Gizmo
        ...
        auto xPlusLine = addOverlayModel(_registry, {GizmoLineLength, 0, 0}, Red, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        _registry->getComponent<TransformComponent>(xPlusLine).setScale({GizmoLineLength, GizmoLineWidth, GizmoLineWidth});
        auto yPlusLine = addOverlayModel(_registry, {0, GizmoLineLength, 0}, Green, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        _registry->getComponent<TransformComponent>(yPlusLine).setScale({GizmoLineWidth, GizmoLineLength, GizmoLineWidth});
        auto zPlusLine = addOverlayModel(_registry, {0, 0, GizmoLineLength}, Blue, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        _registry->getComponent<TransformComponent>(zPlusLine).setScale({GizmoLineWidth, GizmoLineWidth, GizmoLineLength});

        auto xPlusHandle = addOverlayModel(_registry, {2 * GizmoLineLength, 0, 0}, Red, utils::assets::read<Mesh>(Mesh::Factory::Type::CONE));
        ...
        auto yPlusHandle = addOverlayModel(_registry, {0, 2 * GizmoLineLength, 0}, Green, utils::assets::read<Mesh>(Mesh::Factory::Type::CONE));
        ...
        auto zPlusHandle = addOverlayModel(_registry, {0, 0, 2 * GizmoLineLength}, Blue, utils::assets::read<Mesh>(Mesh::Factory::Type::CONE));
    ...
    {  // Scale Gizmo
        ...
        _scaleGizmoLineX = addOverlayModel(_registry, {GizmoLineLength, 0, 0}, Red, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        _registry->getComponent<TransformComponent>(_scaleGizmoLineX).setScale({GizmoLineLength, GizmoLineWidth, GizmoLineWidth});
        _scaleGizmoLineY = addOverlayModel(_registry, {0, GizmoLineLength, 0}, Green, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        _registry->getComponent<TransformComponent>(_scaleGizmoLineY).setScale({GizmoLineWidth, GizmoLineLength, GizmoLineWidth});
        _scaleGizmoLineZ = addOverlayModel(_registry, {0, 0, GizmoLineLength}, Blue, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        _registry->getComponent<TransformComponent>(_scaleGizmoLineZ).setScale({GizmoLineWidth, GizmoLineWidth, GizmoLineLength});

        auto xPlusHandle = addOverlayModel(_registry, {2 * GizmoLineLength, 0, 0}, Red, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        ...
        auto yPlusHandle = addOverlayModel(_registry, {0, 2 * GizmoLineLength, 0}, Green, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        ...
        auto zPlusHandle = addOverlayModel(_registry, {0, 0, 2 * GizmoLineLength}, Blue, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
        ...
        _scaleUniformHandle = addOverlayModel(_registry, {0, 0, 0}, Grey, utils::assets::read<Mesh>(Mesh::Factory::Type::CUBE));
...
glm::vec3 GizmoSystem::getSelectedHandleDisplacement() const {
    ...
    SHKYERA_ASSERT(_registry->getEntity<SceneCamera>().has_value(), "Cannot get displacement, because SceneCamera is not registered");

    const auto& cameraComponent = _registry->getComponent<CameraComponent>(*_registry->getEntity<SceneCamera>());
    const auto& cameraTransformComponent = _registry->getComponent<TransformComponent>(*_registry->getEntity<SceneCamera>());
