...
void CameraMovementSystem<MainCameraTag>::setupCameraMovement() {
    SHKYERA_ASSERT(_registry->getEntity<MainCameraTag>().has_value(), "There is no entity with component {}. Cannot initialize CameraMovementSystem", typeid(MainCameraTag).name());
