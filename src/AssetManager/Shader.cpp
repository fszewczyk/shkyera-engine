...
Shader::Shader(const std::filesystem::path& filepath, Type type) : _type(type) {
...
Shader::Shader(Shader&& other) noexcept : _id(std::exchange(other._id, 0)), _type(other._type) {}
