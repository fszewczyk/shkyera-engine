...
ParticleEmitterComponentUI::ParticleEmitterComponentUI(std::shared_ptr<Registry> registry,
    ...
    : ComponentUI("resources/icons/components/particles.png"),
      ...
      _emittedPerSecondVarianceSlider("Frequency Variance", particleEmitterComponent->emittedPerSecondVariance, 0.0f,
                                      1.0f),
      _initialVelocitySlider("Initial Velocity", particleEmitterComponent->initialVelocity, 0.0f, 5.0f),
      _initialVelocityVarianceSlider("Initial Velocity Variance", particleEmitterComponent->initialVelocity, 0.0f,
                                     1.0f),
      _initialVelocityDispersionSlider("Velocity Disperion", particleEmitterComponent->initialVelocityDispersion, -1.0f,
                                       1.0f),
      ...
      _initialParticleSizeVarianceSlider("Start Size Variance", particleEmitterComponent->initialParticleSizeVariance,
                                         0.0f, 1.0f),
      _endParticleSizeSlider("End Size", particleEmitterComponent->endParticleSize, 0.0f, 1.0f),
      _endParticleSizeVarianceSlider("End Size Variance", particleEmitterComponent->endParticleSizeVariance, 0.0f,
                                     1.0f),
      ...
      _initialTransparencyVarianceSlider("Start Alpha Variance", particleEmitterComponent->initialTransparencyVariance,
                                         0.0f, 1.0f),
      _endTransparencySlider("End Alpha", particleEmitterComponent->endTransparency, 0.0f, 1.0f),
      _endTransparencyVarianceSlider("End Alpha Variance", particleEmitterComponent->endTransparencyVariance, 0.0f,
                                     1.0f) {
  _enabledSelector.setUpdateCallback([this](auto enabled) { _particleEmitterComponent->enabled = enabled; });

  _materialSelector.setClearCallback(
      [this]() { _particleEmitterComponent->material = HandleAndAsset<Material>{std::nullopt, nullptr}; });
  ...
  auto setSliderCallback = [this](auto& slider, auto& member) {
    slider.setUpdateCallback([this, &member](float value) { member = value; });
  };
