...
BillboardComponentUI::BillboardComponentUI(std::shared_ptr<Registry> registry, BillboardComponent<>* billboardComponent)
    : _billboardComponent(billboardComponent),
      ...
      _orientationSelector("Orientation", _billboardComponent->orientation, {{BillboardComponent<>::Orientation::CameraFacing, "Camera Facing"}, {BillboardComponent<>::Orientation::AxisAligned, "Axis Aligned"}, {BillboardComponent<>::Orientation::WorldFixed, "World Fixed"}}),
      _scaleSelector("Scale", _billboardComponent->scale, {{BillboardComponent<>::Scale::Camera, "Camera Fixed"}, {BillboardComponent<>::Scale::World, "World Fixed"}}),
      _occlusionSelector("Occlusion", _billboardComponent->occlusion, {{BillboardComponent<>::Occlusion::Occludable, "Occludable"}, {BillboardComponent<>::Occlusion::NotOccludable, "Not Occludable"}}) {
