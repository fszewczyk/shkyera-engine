...
ColorSelector::ColorSelector(const std::string& title)
    : _title(title), _imguiIdentifier("##" + _title + "ColorSelector") {}

ColorSelector::ColorSelector(const std::string& title, const glm::vec3& color)
    : _title(title), _imguiIdentifier("##" + _title + "ColorSelector"), _color(color) {}
