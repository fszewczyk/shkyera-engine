...
FilesystemWidget::FilesystemWidget(std::string name, std::shared_ptr<Registry> registry, AssetHandle rootDirectoryHandle)
    : Widget(name), _registry(registry), _rootDirectoryHandle(rootDirectoryHandle), _currentDirectoryHandle(rootDirectoryHandle) {
