...
DepthAtlasFrameBuffer::DepthAtlasFrameBuffer(int texturesInAtlas, GLenum minFilter, GLenum magFilter, GLenum wrapS,
                                             GLenum wrapT)
    : _texturesInAtlas(texturesInAtlas),
      _width(2048),
      _height(2048),
...
void DepthAtlasFrameBuffer::bind(int index) {
  ...
  glViewport(static_cast<GLsizei>(index * _width / _texturesInAtlas), 0,
             static_cast<GLsizei>(_width / _texturesInAtlas), static_cast<GLsizei>(_height));
}
