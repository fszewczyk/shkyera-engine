...
DepthCubeMapFrameBuffer::DepthCubeMapFrameBuffer() : _width(1024), _height(1024) {
  setupFramebuffer();
...
void DepthCubeMapFrameBuffer::setSize(int width, int height) {
  ...
  for (GLuint i = 0; i < 6; ++i) {
    glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, GL_DEPTH_COMPONENT24, _width, _height, 0, GL_DEPTH_COMPONENT,
                 GL_FLOAT, nullptr);
  }
