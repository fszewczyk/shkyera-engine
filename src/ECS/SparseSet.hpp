...
class SparseSet : public SparseSetBase {
 public:
  ...
  class Iterator {
   public:
    ...
    using value_type =
        std::pair<Entity,
                  std::conditional_t<IsConst, const Component, Component>>;
    using difference_type = std::ptrdiff_t;
    using pointer = value_type*;
    using reference = value_type&;

    // Constructor
    Iterator(typename std::conditional_t<IsConst, const std::vector<Entity>*,
                                         std::vector<Entity>*>
                 entities,
             typename std::conditional_t<IsConst, const std::vector<Component>*,
   ...
   private:
    typename std::conditional_t<IsConst, const std::vector<Entity>*,
                                std::vector<Entity>*>
        _entities;
    typename std::conditional_t<IsConst, const std::vector<Component>*,
                                std::vector<Component>*>
 ...
 private:
  std::vector<Entity>
      _entities; /**< Stores entities associated with components. */
  std::unordered_map<Entity, size_t>
      _entityToComponent; /**< Maps entities to their component indices. */
  std::vector<Component>
      _components; /**< Stores components associated with entities. */
};
