...
class SparseSet : public SparseSetBase {
 public:
  ...
  /**
     ...
     */
  bool contains(Entity entity) const { return _entityToComponent.find(entity) != _entityToComponent.end(); }
  ...
  /**
     ...
     */
  Component& get(Entity entity) { return _components[_entityToComponent.at(entity)]; }
  ...
  /**
     ...
     */
  const Component& get(Entity entity) const { return _components[_entityToComponent.at(entity)]; }
  ...
  class Iterator {
   public:
    ...
    reference operator*() const { return {(*_entities)[_index], (*_components)[_index]}; }
  ...
  iterator begin() { return iterator(&_entities, &_components, 0); }

  iterator end() { return iterator(&_entities, &_components, _entities.size()); }

  const_iterator begin() const { return const_iterator(&_entities, &_components, 0); }

  const_iterator end() const { return const_iterator(&_entities, &_components, _entities.size()); }
